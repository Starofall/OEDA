...
def search_for_open_experiments():
    ...
    try:
        ...
        openExperiments = findOpenExperiments()
        # go through all open experiments and fork_n_run them on RTX
        map(fork_and_run_experiment, openExperiments)
...
def fork_and_run_experiment(experiment):
    ...
    targetSystem = getTargetSystem(experiment["targetId"])
...
def rtxExecution(experiment, targetSystem):
    ...
    try:
        ...
        setTargetSystemStatus(experiment["targetId"], "WORKING")
